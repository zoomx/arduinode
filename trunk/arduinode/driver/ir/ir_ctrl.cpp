 ...
 ************************************************************************/
void IR_BufferIn(unsigned char data) {
  #if RAWMODE
...
// 
// void BufferIn(unsigned char data) {
...
unsigned char RXbyte() {
  ...
  PORTB = (PORTB & 1) ^1; // FIXME 
  return c;
}

// FIXME implement as tick function 
...
//   pktInspection(); gibts nich nehr
//   PORTB &= 0;  // led off // FIXME 
  }
  PT_END(pt);
}


void IR_carrierSense() {	// FIXME HACK
