...
#define PKTTIMEOUT 1000		// how many ms to wait for an ACK before resending the pkt
#define PKTRETRY 4		// how many times to retry until to delete this node from the node table
